...
const treeApiUrl = (forestId: number, treeId: number) => {
  return `${baseUrl}/${forestId}/tree/${treeId}`
}

const branchApiUrl = (forestId: number, treeId: number, branchId: number) => {
  return `${baseUrl}/${forestId}/tree/${treeId}/branch/${branchId}`
}
...
const seedApiUrl = (
  ...
  return `${baseUrl}/${forestId}/tree/${treeId}/branch/${branchId}/seed/${seedId}`
}
...
const budApiUrl = (
  ...
  return `${baseUrl}/${forestId}/tree/${treeId}/branch/${branchId}/bud/${budId}`
}
