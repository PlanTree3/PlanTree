...
values (UNHEX(REPLACE('a0f42975-33ef-4500-85cd-1817d7a8f431', '-', '')), '나의 라임오렌지나무1','2023-10-02', '2023-10-08', UNHEX(REPLACE('cdd10ab0-58cf-459b-a78f-56b881ae68c5', '-', '')), UNHEX(REPLACE('63b61c82-5f91-4e0a-983e-2c22dd6b65d3', '-', ''))),
       ...
       (UNHEX(REPLACE('9839fc1d-843c-491c-9a71-5c1b8efb22c7', '-', '')), '나의 라임오렌지나무5','2023-10-30', '2023-11-04', UNHEX(REPLACE('c2fba506-e07e-428c-af51-c63b98960a41', '-', '')), UNHEX(REPLACE('6b9cfd4c-e61a-4d2e-8ec5-55f92d2f5a19', '-', '')));
...
values (UNHEX(REPLACE('2d9ddfa1-d6a2-4a6f-b25a-b92619001d0c', '-', '')), '수학 문제 풀기1', 'MON', true, UNHEX(REPLACE('cdd10ab0-58cf-459b-a78f-56b881ae68c5', '-', '')), UNHEX(REPLACE('2d9ddfa1-d6a2-4a6f-b25a-b92619001d0c', '-', ''))),
       (UNHEX(REPLACE('6cd8b78d-1b3a-4c72-93be-7d6b6e11a98d', '-', '')), '수학 문제 풀기2', 'TUE', false,UNHEX(REPLACE('cdd10ab0-58cf-459b-a78f-56b881ae68c5', '-', '')), UNHEX(REPLACE('2d9ddfa1-d6a2-4a6f-b25a-b92619001d0c', '-', ''))),
       (UNHEX(REPLACE('2e65ca6e-6019-4e2a-83a2-47c93b1e03f7', '-', '')), '수학 문제 풀기3', 'MON', true,UNHEX(REPLACE('cdd10ab0-58cf-459b-a78f-56b881ae68c5', '-', '')), UNHEX(REPLACE('2d9ddfa1-d6a2-4a6f-b25a-b92619001d0c', '-', ''))),
       (UNHEX(REPLACE('49e3e2e2-6162-4b84-bdda-b3ac006bbdbb', '-', '')), '수학 문제 풀기4', 'MON', false,UNHEX(REPLACE('cdd10ab0-58cf-459b-a78f-56b881ae68c5', '-', '')), UNHEX(REPLACE('2d9ddfa1-d6a2-4a6f-b25a-b92619001d0c', '-', ''))),
       (UNHEX(REPLACE('8c9432f2-ae33-4ee6-b61d-cb454a1a1d9a', '-', '')), '수학 문제 풀기5', 'MON', true,UNHEX(REPLACE('cdd10ab0-58cf-459b-a78f-56b881ae68c5', '-', '')), UNHEX(REPLACE('2d9ddfa1-d6a2-4a6f-b25a-b92619001d0c', '-', ''))),
       (UNHEX(REPLACE('7b5421ca-4d89-4d1d-80b9-6533aaacdd3a', '-', '')), '영어 문제 풀기1', 'MON', true,UNHEX(REPLACE('c2fba506-e07e-428c-af51-c63b98960a41', '-', '')), UNHEX(REPLACE('7b5421ca-4d89-4d1d-80b9-6533aaacdd3a', '-', ''))),
       (UNHEX(REPLACE('4f68b02b-0ca7-4c5a-8192-660f20b25132', '-', '')), '영어 문제 풀기2', 'TUE', false,UNHEX(REPLACE('c2fba506-e07e-428c-af51-c63b98960a41', '-', '')), UNHEX(REPLACE('7b5421ca-4d89-4d1d-80b9-6533aaacdd3a', '-', ''))),
       (UNHEX(REPLACE('b7d74ef2-9a20-44ea-9527-4b3c9b3bd8a6', '-', '')), '영어 문제 풀기3', 'TUE', true,UNHEX(REPLACE('c2fba506-e07e-428c-af51-c63b98960a41', '-', '')), UNHEX(REPLACE('7b5421ca-4d89-4d1d-80b9-6533aaacdd3a', '-', ''))),
       (UNHEX(REPLACE('d3e9c11c-d52c-4b77-8fc5-7e1e0839f90c', '-', '')), '영어 문제 풀기4', 'TUE', false,UNHEX(REPLACE('c2fba506-e07e-428c-af51-c63b98960a41', '-', '')), UNHEX(REPLACE('7b5421ca-4d89-4d1d-80b9-6533aaacdd3a', '-', ''))),
       (UNHEX(REPLACE('2e96a422-0a32-4d67-9e63-2a3c82568d85', '-', '')), '영어 문제 풀기5', 'TUE', true,UNHEX(REPLACE('c2fba506-e07e-428c-af51-c63b98960a41', '-', '')), UNHEX(REPLACE('7b5421ca-4d89-4d1d-80b9-6533aaacdd3a', '-', '')));
